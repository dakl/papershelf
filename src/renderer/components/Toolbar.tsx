      ...
      <div className="absolute" style={{ top: 10, left: 76 }}>
        <ShortcutHint shortcutId="toggleSidebar">
          <button
            ...
            className="no-drag w-[28px] h-[28px] flex items-center justify-center rounded-md hover:bg-black/5 dark:hover:bg-white/10 transition-colors cursor-pointer text-gray-500 dark:text-gray-400"
